...
lris=pd.DataFrame(lris.data, columns = lris.feature_names)
...
g = sns.pairplot(lris,hue="sepal width (cm)")
...
for i in range(1, 11):
    kmeans = KMeans(n_clusters = i, init = 'k-means++', 
                    max_iter = 400, n_init = 10, random_state = 2)
    kmeans.fit(x)
